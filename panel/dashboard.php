  ...
  <body>
    ...
    <div class="container" id="main">
      <div class="row">
          <div class="col-md-12">
            <fieldset>
              <legend>Ultimos 10 Pedidos</legend>
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>Q<?php echo htmlspecialchars($item['total']); ?></td>
                    <td><?php echo htmlspecialchars($item['fecha']); ?></td>
                    <td class="text-center">
                      <a href="pedidos/ver.php?id=<?php echo $item['id']; ?>" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-eye-open"></span></a>
                    </td>
                  </tr>
